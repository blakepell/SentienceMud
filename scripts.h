...
enum ifcheck_enum {
	...
	/* O */
	CHK_OBJCOND,CHK_OBJCOST,CHK_OBJEXISTS,CHK_OBJEXTRA,CHK_OBJEXTRA2,CHK_OBJEXTRA3,
	CHK_OBJEXTRA4,CHK_OBJFRAG,CHK_OBJHERE,
	CHK_OBJMAXWEIGHT,CHK_OBJTIMER,CHK_OBJTYPE,CHK_OBJVAL0,CHK_OBJVAL1,CHK_OBJVAL2,
	CHK_OBJVAL3,CHK_OBJVAL4,CHK_OBJVAL5,CHK_OBJVAL6,CHK_OBJVAL7,CHK_OBJWEAR,
	CHK_OBJWEARLOC,CHK_OBJWEIGHT,CHK_OBJWEIGHTLEFT,CHK_OFF,CHK_ORDER,
	...
	CHK_THIRST,CHK_TIMEOFDAY,CHK_TIMER,CHK_TOKENCOUNT,CHK_TOKENEXISTS,
...
enum entity_mobile_enum {
	...
	ENTITY_MOB_EQ_TATTOO_ARM1,
	ENTITY_MOB_EQ_TATTOO_ARM2,
	ENTITY_MOB_EQ_TATTOO_LEG1,
	ENTITY_MOB_EQ_TATTOO_LEG2,
