 ...
 */
#define IMC_VERSION_STRING "IMC2 MC Freedom CL-2.2 "
...
#define IMC_SERVER_FILE  IMC_DIR "imc.servers"
...
typedef struct server_data    SERVER_DATA; /* server information */
...
struct imc_packet
{
   ...
   char network[SMST]; /* This is only used internally and not sent */
};
