...
#define WEAR_TATTOO_ARM_L	30
#define WEAR_TATTOO_ARM_R	31
#define WEAR_TATTOO_LEG_L	32
#define WEAR_TATTOO_LEG_R	33
...
OD *	get_obj_carry	args( ( CHAR_DATA *ch, char *argument,
			    CHAR_DATA *viewer ) );
OD *	get_obj_vnum_carry	args( ( CHAR_DATA *ch, long vnum,
			    CHAR_DATA *viewer ) );
