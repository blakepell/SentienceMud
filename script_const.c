...
//	name,					alias, 		type,					slot,			mob?,	obj?,	room?,	token?
{	"act",					NULL,		TRIG_ACT,				TRIGSLOT_ACTION,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"afterdeath",			NULL,		TRIG_AFTERDEATH,		TRIGSLOT_REPOP,		FALSE,	FALSE,	FALSE,	TRUE	},
{	"afterkill",			NULL,		TRIG_AFTERKILL,			TRIGSLOT_FIGHT,		TRUE,	TRUE,	TRUE,	TRUE	},
{	"animate",				NULL,		TRIG_ANIMATE,			TRIGSLOT_ANIMATE,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"assist",				NULL,		TRIG_ASSIST,			TRIGSLOT_FIGHT,		TRUE,	FALSE,	FALSE,	TRUE	},
{	"attack_backstab",		NULL,		TRIG_ATTACK_BACKSTAB,	TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"attack_bash",			NULL,		TRIG_ATTACK_BASH,		TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"attack_behead",		NULL,		TRIG_ATTACK_BEHEAD,		TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"attack_bite",			NULL,		TRIG_ATTACK_BITE,		TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"attack_blackjack",		NULL,		TRIG_ATTACK_BLACKJACK,	TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"attack_circle",		NULL,		TRIG_ATTACK_CIRCLE,		TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"attack_counter",		NULL,		TRIG_ATTACK_COUNTER,	TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"attack_cripple",		NULL,		TRIG_ATTACK_CRIPPLE,	TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"attack_dirtkick",		NULL,		TRIG_ATTACK_DIRTKICK,	TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"attack_disarm",		NULL,		TRIG_ATTACK_DISARM,		TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"attack_intimidate",	NULL,		TRIG_ATTACK_INTIMIDATE,	TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"attack_kick",			NULL,		TRIG_ATTACK_KICK,		TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"attack_rend",			NULL,		TRIG_ATTACK_REND,		TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"attack_slit",			NULL,		TRIG_ATTACK_SLIT,		TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"attack_smite",			NULL,		TRIG_ATTACK_SMITE,		TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"attack_tailkick",		NULL,		TRIG_ATTACK_TAILKICK,	TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"attack_trample",		NULL,		TRIG_ATTACK_TRAMPLE,	TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"attack_turn",			NULL,		TRIG_ATTACK_TURN,		TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"barrier",				NULL,		TRIG_BARRIER,			TRIGSLOT_ATTACKS,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"blow",					NULL,		TRIG_BLOW,				TRIGSLOT_GENERAL,	FALSE,	TRUE,	FALSE,	FALSE	},
{	"board",				NULL,		TRIG_BOARD,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"brandish",				NULL,		TRIG_BRANDISH,			TRIGSLOT_GENERAL,	FALSE,	TRUE,	FALSE,	TRUE	},
{	"bribe",				NULL,		TRIG_BRIBE,				TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"bury",					NULL,		TRIG_BURY,				TRIGSLOT_GENERAL,	FALSE,	TRUE,	TRUE,	TRUE	},
{	"caninterrupt",			NULL,		TRIG_CANINTERRUPT,		TRIGSLOT_INTERRUPT,	FALSE,	FALSE,	FALSE,	TRUE	},
{	"catalyst",				NULL,		TRIG_CATALYST,			TRIGSLOT_GENERAL,	FALSE,  TRUE,	FALSE,	FALSE	},
{	"catalystfull",			NULL,		TRIG_CATALYST_FULL,		TRIGSLOT_GENERAL,	FALSE,  TRUE,	FALSE,	FALSE	},
{	"catalystsrc",			NULL,		TRIG_CATALYST_SOURCE,	TRIGSLOT_GENERAL,	FALSE,  TRUE,	FALSE,	FALSE	},
{	"check_damage",			NULL,		TRIG_CHECK_DAMAGE,		TRIGSLOT_DAMAGE,	TRUE, TRUE, TRUE, TRUE	},
{	"clone_extract",		NULL,		TRIG_CLONE_EXTRACT,		TRIGSLOT_GENERAL,	FALSE,  FALSE,	TRUE,	TRUE	},
{	"close",				NULL,		TRIG_CLOSE,				TRIGSLOT_GENERAL,	FALSE,  TRUE,	TRUE,	TRUE	},
{	"combatstyle",			NULL,		TRIG_COMBAT_STYLE,		TRIGSLOT_COMBATSTYLE,	FALSE, FALSE, FALSE, TRUE	},	// Only on tokens
{	"damage",				NULL,		TRIG_DAMAGE,			TRIGSLOT_DAMAGE,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"death",				NULL,		TRIG_DEATH,				TRIGSLOT_REPOP,		TRUE,	FALSE,	TRUE,	TRUE	},
{	"death_protection",		NULL,		TRIG_DEATH_PROTECTION,	TRIGSLOT_REPOP,		TRUE,	FALSE,	TRUE,	TRUE	},
{	"death_timer",			NULL,		TRIG_DEATH_TIMER,		TRIGSLOT_REPOP,		TRUE,	FALSE,	TRUE,	TRUE	},
{	"defense",				NULL,		TRIG_DEFENSE,			TRIGSLOT_COMBATSTYLE,	TRUE, FALSE, FALSE, TRUE	},	// Only on tokens
{	"delay",				NULL,		TRIG_DELAY,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"drink",				NULL,		TRIG_DRINK,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"drop",					NULL,		TRIG_DROP,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"eat",					NULL,		TRIG_EAT,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"emote",				NULL,		TRIG_EMOTE,				TRIGSLOT_ACTION,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"emoteat",				NULL,		TRIG_EMOTEAT,			TRIGSLOT_ACTION,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"emoteself",			NULL,		TRIG_EMOTESELF,			TRIGSLOT_ACTION,	FALSE,	FALSE,	FALSE,	TRUE	},
{	"entry",				NULL,		TRIG_ENTRY,				TRIGSLOT_MOVE,		TRUE,	TRUE,	TRUE,	TRUE	},
{	"exall",				NULL,		TRIG_EXALL,				TRIGSLOT_MOVE,		TRUE,	TRUE,	TRUE,	TRUE	},
{	"examine",				NULL,		TRIG_EXAMINE,			TRIGSLOT_GENERAL,	FALSE,	TRUE,	FALSE,	TRUE	},
{	"exit",					NULL,		TRIG_EXIT,				TRIGSLOT_MOVE,		TRUE,	TRUE,	TRUE,	TRUE	},
{	"expire",				NULL,		TRIG_EXPIRE,			TRIGSLOT_REPOP,		FALSE,	FALSE,	FALSE,	TRUE	},
{	"extract",				NULL,		TRIG_EXTRACT,			TRIGSLOT_REPOP,		TRUE,	TRUE,	TRUE,	FALSE	},
{	"fight",				NULL,		TRIG_FIGHT,				TRIGSLOT_FIGHT,		TRUE,	TRUE,	TRUE,	TRUE	},
{	"flee",					NULL,		TRIG_FLEE,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"forcedismount",		NULL,		TRIG_FORCEDISMOUNT,		TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"get",					NULL,		TRIG_GET,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"give",					NULL,		TRIG_GIVE,				TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"grall",				NULL,		TRIG_GRALL,				TRIGSLOT_MOVE,		TRUE,	TRUE,	TRUE,	TRUE	},
{	"greet",				NULL,		TRIG_GREET,				TRIGSLOT_MOVE,		TRUE,	TRUE,	TRUE,	TRUE	},
{	"grouped",				NULL,		TRIG_GROUPED,			TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"grow",					NULL,		TRIG_GROW,				TRIGSLOT_RANDOM,	FALSE,	TRUE,	FALSE,	TRUE	},
{	"hidden",				NULL,		TRIG_HIDDEN,			TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"hide",					NULL,		TRIG_HIDE,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	FALSE,	TRUE	},
{	"hit",					NULL,		TRIG_HIT,				TRIGSLOT_HITS,		TRUE,	FALSE,	FALSE,	TRUE	},
{	"hpcnt",				NULL,		TRIG_HPCNT,				TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"identify",				NULL,		TRIG_IDENTIFY,			TRIGSLOT_GENERAL,	FALSE,	TRUE,	FALSE,	TRUE	},
{	"interrupt",			NULL,		TRIG_INTERRUPT,			TRIGSLOT_INTERRUPT,	FALSE,	FALSE,	FALSE,	TRUE	},
{	"kill",					NULL,		TRIG_KILL,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"knock",				NULL,		TRIG_KNOCK,				TRIGSLOT_GENERAL,	FALSE,	FALSE,	TRUE,	TRUE	},
{	"knocking",				NULL,		TRIG_KNOCKING,			TRIGSLOT_GENERAL,	FALSE,	FALSE,	TRUE,	TRUE	},
{	"land",					NULL,		TRIG_LAND,				TRIGSLOT_MOVE,		TRUE,	FALSE,	FALSE,	TRUE	},
{	"level",				NULL,		TRIG_LEVEL,				TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"login",				NULL,		TRIG_LOGIN,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"lore",					NULL,		TRIG_LORE,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	FALSE,	TRUE	},
{	"lorex",				NULL,		TRIG_LORE_EX,			TRIGSLOT_GENERAL,	TRUE,	TRUE,	FALSE,	TRUE	},
{	"moon",					NULL,		TRIG_MOON,				TRIGSLOT_GENERAL,	FALSE,	FALSE,	FALSE,	TRUE	},
...
{	"preassist",			NULL,		TRIG_PREASSIST,			TRIGSLOT_FIGHT,		TRUE,	FALSE,	FALSE,	TRUE	},
{	"prebite",				NULL,		TRIG_PREBITE,			TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"prebuy",				NULL,		TRIG_PREBUY,			TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"precast",				NULL,		TRIG_PRECAST,			TRIGSLOT_GENERAL,	FALSE,	FALSE,	FALSE,	TRUE	},
{	"predeath",				NULL,		TRIG_PREDEATH,			TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"predismount",			NULL,		TRIG_PREDISMOUNT,		TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"predrink",				NULL,		TRIG_PREDRINK,			TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"predrop",				NULL,		TRIG_PREDROP,			TRIGSLOT_GENERAL,	FALSE,	TRUE,	FALSE,	TRUE	},
{	"preeat",				NULL,		TRIG_PREEAT,			TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"preenter",				NULL,		TRIG_PREENTER,			TRIGSLOT_MOVE,		FALSE,	TRUE,	TRUE,	TRUE	},
{	"preflee",				NULL,		TRIG_PREFLEE,			TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"preget",				NULL,		TRIG_PREGET,			TRIGSLOT_GENERAL,	FALSE,	TRUE,	FALSE,	TRUE	},
{	"prehide",				NULL,		TRIG_PREHIDE,			TRIGSLOT_GENERAL,	TRUE,	TRUE,	FALSE,	TRUE	},
{	"prehidein",			NULL,		TRIG_PREHIDE_IN,		TRIGSLOT_GENERAL,	TRUE,	TRUE,	FALSE,	TRUE	},
{	"prekill",				NULL,		TRIG_PREKILL,			TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"premount",				NULL,		TRIG_PREMOUNT,			TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"prepractice",			NULL,		TRIG_PREPRACTICE,		TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"prepracticeother",		NULL,		TRIG_PREPRACTICEOTHER,	TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
...
{	"preremove",			NULL,		TRIG_PREREMOVE,			TRIGSLOT_GENERAL,	FALSE,	TRUE,	FALSE,	TRUE	},
{	"prerest",				NULL,		TRIG_PREREST,			TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"preresurrect",			NULL,		TRIG_PRERESURRECT,		TRIGSLOT_REPOP,		TRUE,	TRUE,	TRUE,	TRUE	},
{	"preround",				NULL,		TRIG_PREROUND,			TRIGSLOT_FIGHT,		TRUE,	FALSE,	FALSE,	TRUE	},
{	"presell",				NULL,		TRIG_PRESELL,			TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"presit",				NULL,		TRIG_PRESIT,			TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"presleep",				NULL,		TRIG_PRESLEEP,			TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"prespell",				NULL,		TRIG_PRESPELL,			TRIGSLOT_SPELL,		FALSE,	FALSE,	FALSE,	TRUE	},
{	"prestand",				NULL,		TRIG_PRESTAND,			TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"pretrain",				NULL,		TRIG_PRETRAIN,			TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"pretraintoken",		NULL,		TRIG_PRETRAINTOKEN,		TRIGSLOT_GENERAL,	FALSE,	FALSE,	FALSE,	TRUE	},
{	"prewake",				NULL,		TRIG_PREWAKE,			TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"prewear",				NULL,		TRIG_PREWEAR,			TRIGSLOT_GENERAL,	FALSE,	TRUE,	FALSE,	TRUE	},
{	"prewimpy",				NULL,		TRIG_PREWIMPY,			TRIGSLOT_FIGHT,		TRUE,	TRUE,	TRUE,	TRUE	},
{	"pull",					NULL,		TRIG_PULL,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	FALSE,	TRUE	},
{	"pullon",				NULL,		TRIG_PULL_ON,			TRIGSLOT_GENERAL,	TRUE,	TRUE,	FALSE,	TRUE	},
...
{	"recite",				NULL,		TRIG_RECITE,			TRIGSLOT_GENERAL,	FALSE,	TRUE,	FALSE,	TRUE	},
{	"reckoning",			NULL,		TRIG_RECKONING,			TRIGSLOT_RANDOM,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"regen",				NULL,		TRIG_REGEN,				TRIGSLOT_RANDOM,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"regen_hp",				NULL,		TRIG_REGEN_HP,			TRIGSLOT_RANDOM,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"regen_mana",			NULL,		TRIG_REGEN_MANA,		TRIGSLOT_RANDOM,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"regen_move",			NULL,		TRIG_REGEN_MOVE,		TRIGSLOT_RANDOM,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"remort",				NULL,		TRIG_REMORT,			TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"remove",				NULL,		TRIG_REMOVE,			TRIGSLOT_GENERAL,	FALSE,  TRUE,	FALSE,	TRUE	},
{	"repop",				NULL,		TRIG_REPOP,				TRIGSLOT_REPOP,		TRUE,	TRUE,	FALSE,	TRUE	},
{	"rest",					NULL,		TRIG_REST,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"restore",				NULL,		TRIG_RESTORE,			TRIGSLOT_REPOP,		TRUE,	FALSE,	FALSE,	TRUE	},
{	"resurrect",			NULL,		TRIG_RESURRECT,			TRIGSLOT_REPOP,		TRUE,	FALSE,	FALSE,	TRUE	},
{	"save",					NULL,		TRIG_SAVE,				TRIGSLOT_REPOP,		TRUE,	TRUE,	FALSE,	TRUE	},
{	"sayto",				NULL,		TRIG_SAYTO,				TRIGSLOT_SPEECH,	TRUE,	TRUE,	FALSE,	TRUE	},
{	"sit",					NULL,		TRIG_SIT,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"skill_berserk",		NULL,		TRIG_SKILL_BERSERK,		TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"skill_sneak",			NULL,		TRIG_SKILL_SNEAK,		TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"skill_warcry",			NULL,		TRIG_SKILL_WARCRY,		TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"sleep",				NULL,		TRIG_SLEEP,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"speech",				NULL,		TRIG_SPEECH,			TRIGSLOT_SPEECH,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"spell",				NULL,		TRIG_SPELL,				TRIGSLOT_SPELL,		FALSE,	FALSE,	FALSE,	TRUE	},
{	"spellbeat",			NULL,		TRIG_SPELLBEAT,			TRIGSLOT_SPELL,		FALSE,	FALSE,	FALSE,	TRUE	},
{	"spellcast",			NULL,		TRIG_SPELLCAST,			TRIGSLOT_SPELL,		TRUE,	TRUE,	TRUE,	TRUE	},
{	"spellinter",			NULL,		TRIG_SPELLINTER,		TRIGSLOT_SPELL,		FALSE,	FALSE,	FALSE,	TRUE	},
{	"spellpenetrate",		NULL,		TRIG_SPELLPENETRATE,	TRIGSLOT_SPELL,		FALSE,	FALSE,	FALSE,	TRUE	},
{	"spellreflect",			NULL,		TRIG_SPELLREFLECT,		TRIGSLOT_SPELL,		TRUE,	FALSE,	FALSE,	TRUE	},
{	"spell_cure",			NULL,		TRIG_SPELL_CURE,		TRIGSLOT_SPELL,		TRUE,	FALSE,	FALSE,	TRUE	},
{	"spell_dispel",			NULL,		TRIG_SPELL_DISPEL,		TRIGSLOT_SPELL,		TRUE,	TRUE,	FALSE,	TRUE	},
{	"stand",				NULL,		TRIG_STAND,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"startcombat",			NULL,		TRIG_START_COMBAT,		TRIGSLOT_FIGHT,		TRUE,	TRUE,	TRUE,	TRUE	},
{	"stripaffect",			NULL,		TRIG_STRIPAFFECT,		TRIGSLOT_REPOP,		FALSE,	FALSE,	FALSE,	TRUE	},
{	"takeoff",				NULL,		TRIG_TAKEOFF,			TRIGSLOT_MOVE,		TRUE,	FALSE,	FALSE,	TRUE	},
{	"throw",				NULL,		TRIG_THROW,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"touch",				NULL,		TRIG_TOUCH,				TRIGSLOT_GENERAL,	FALSE,	TRUE,	FALSE,	TRUE	},
{	"turn",					NULL,		TRIG_TURN,				TRIGSLOT_GENERAL,	FALSE,	TRUE,	FALSE,	TRUE	},
{	"turnon",				NULL,		TRIG_TURN_ON,			TRIGSLOT_GENERAL,	FALSE,	TRUE,	FALSE,	TRUE	},
{	"ungrouped",			NULL,		TRIG_UNGROUPED,			TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"use",					NULL,		TRIG_USE,				TRIGSLOT_GENERAL,	FALSE,	TRUE,	FALSE,	TRUE	},
{	"usewith",				NULL,		TRIG_USEWITH,			TRIGSLOT_GENERAL,	FALSE,	TRUE,	FALSE,	TRUE	},
{	"verb",					NULL,		TRIG_VERB,				TRIGSLOT_VERB,		TRUE,	TRUE,	TRUE,	TRUE	},
{	"verbself",				NULL,		TRIG_VERBSELF,			TRIGSLOT_VERB,		FALSE,	FALSE,	FALSE,	TRUE	},
{	"wake",					NULL,		TRIG_WAKE,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"weapon_blocked",		NULL,		TRIG_WEAPON_BLOCKED,	TRIGSLOT_ATTACKS,	FALSE,	TRUE,	FALSE,	TRUE	},
{	"weapon_caught",		NULL,		TRIG_WEAPON_CAUGHT,		TRIGSLOT_ATTACKS,	FALSE,	TRUE,	FALSE,	TRUE	},
{	"weapon_parried",		NULL,		TRIG_WEAPON_PARRIED,	TRIGSLOT_ATTACKS,	FALSE,	TRUE,	FALSE,	TRUE	},
{	"wear",					NULL,		TRIG_WEAR,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"whisper",				NULL,		TRIG_WHISPER,			TRIGSLOT_SPEECH,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"wimpy",				NULL,		TRIG_WIMPY,				TRIGSLOT_FIGHT,		TRUE,	TRUE,	TRUE,	TRUE	},
{	"xpgain",				NULL,		TRIG_XPGAIN,			TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"zap",					NULL,		TRIG_ZAP,				TRIGSLOT_GENERAL,	FALSE,	TRUE,	FALSE,	TRUE	},
{	NULL,					NULL,		0,						TRIGSLOT_GENERAL,	FALSE,	FALSE,	FALSE,	FALSE	}
};
