...
ENT_FIELD entity_game[] = {
	...
	{"players",		ENTITY_GAME_PLAYERS,		ENT_PLIST_CONN },
	{"mortals",		ENTITY_GAME_PLAYERS,		ENT_PLIST_CONN },
	{"morts",		ENTITY_GAME_PLAYERS,		ENT_PLIST_CONN },
	{"immortals",	ENTITY_GAME_IMMORTALS,		ENT_PLIST_CONN },
	{"imms",		ENTITY_GAME_IMMORTALS,		ENT_PLIST_CONN },
	{"staff",		ENTITY_GAME_IMMORTALS,		ENT_PLIST_CONN },
	{"online",		ENTITY_GAME_ONLINE,			ENT_PLIST_CONN },
	{"areas",		ENTITY_GAME_AREAS,			ENT_BLIST_AREA	},
	{"zones",		ENTITY_GAME_AREAS,			ENT_BLIST_AREA	},
	{"wilds",		ENTITY_GAME_WILDS,			ENT_BLIST_WILDS	},
	{"maps",		ENTITY_GAME_WILDS,			ENT_BLIST_WILDS	},
	{"persist",		ENTITY_GAME_PERSIST,		ENT_PERSIST },
	{"churches",	ENTITY_GAME_CHURCHES,		ENT_PLIST_CHURCH },
	{NULL,			0,							ENT_UNKNOWN	}
};

ENT_FIELD entity_persist[] = {
	{"mobiles",		ENTITY_PERSIST_MOBS,		ENT_PLIST_MOB	},
	{"objects",		ENTITY_PERSIST_OBJS,		ENT_PLIST_OBJ	},
	{"rooms",		ENTITY_PERSIST_ROOMS,		ENT_PLIST_ROOM	},
};
...
ENT_FIELD entity_mobile[] = {
	...
	{"carrying",	ENTITY_MOB_CARRYING,	ENT_OLIST_OBJ	},
	{"inv",		ENTITY_MOB_CARRYING,	ENT_OLIST_OBJ	},
	{"tokens",	ENTITY_MOB_TOKENS,	ENT_OLIST_TOK	},
	{"affects",	ENTITY_MOB_AFFECTS,	ENT_OLIST_AFF	},
...
ENT_FIELD entity_object[] = {
	...
	{"contents",	ENTITY_OBJ_CONTENTS,	ENT_OLIST_OBJ	},
	{"inv",		ENTITY_OBJ_CONTENTS,	ENT_OLIST_OBJ	},
	{"items",	ENTITY_OBJ_CONTENTS,	ENT_OLIST_OBJ	},
...
ENT_FIELD entity_room[] = {
	...
	{"mobiles",	ENTITY_ROOM_MOBILES,	ENT_OLIST_MOB	},
	{"objects",	ENTITY_ROOM_OBJECTS,	ENT_OLIST_OBJ	},
	{"tokens",	ENTITY_ROOM_TOKENS,	ENT_OLIST_TOK	},
	...
	{"clones",	ENTITY_ROOM_CLONES,		ENT_BLIST_ROOM	},
	{"wilds",	ENTITY_ROOM_WILDS,		ENT_WILDS	},
	{"clonerooms",	ENTITY_ROOM_CLONEROOMS,	ENT_BLIST_ROOM	},
...
ENT_FIELD entity_area[] = {
	...
	{"rooms",	ENTITY_AREA_ROOMS,	ENT_PLIST_ROOM	},
	{NULL,		0,			ENT_UNKNOWN	}
};
...
ENT_FIELD entity_wilds[] = {
	...
	{"vrooms",	ENTITY_WILDS_VROOMS,	ENT_PLIST_ROOM },
	{NULL,		0,			ENT_UNKNOWN }
};
...
ENT_FIELD entity_church[] = {
	...
	{"treasure",	ENTITY_CHURCH_TREASURE,		ENT_BLIST_ROOM	},
	{"key",			ENTITY_CHURCH_KEY,			ENT_NUMBER	},
	{"online",		ENTITY_CHURCH_ONLINE,		ENT_PLIST_CONN	},
	{"roster",		ENTITY_CHURCH_ROSTER,		ENT_PLIST_STR	},
	{NULL,			0,							ENT_UNKNOWN	}
};
...
struct _entity_type_info entity_type_info[] = {
	...
	{ ENT_BLIST_MIN,	ENT_BLIST_MAX,		entity_list,		FALSE	},
	{ ENT_PLIST_MIN,	ENT_PLIST_MAX,		entity_list,		FALSE	},
	{ ENT_OLIST_MIN,	ENT_OLIST_MAX,		entity_list,		FALSE	},
